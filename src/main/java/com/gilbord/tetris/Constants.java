...
public class Constants {
    ...
    public static final int NUM_OF_CELLS_X = 5;
    ...
    public static final int NEXT_START_X = NUM_OF_CELLS_X + 3;
    public static final int NEXT_START_Y = 6;
    public static final String SCORE_TEXT = "YOUR SCORE IS ";
    public static final int SPACE_FOR_INFO_X = 20;
    public static final int SPACE_FOR_INFO_Y = 300;
    public static final int SPACE_FOR_NEXT_FIGURE = 4 * SIZE_OF_THE_CELL + 20;
